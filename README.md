...
I will update this project soon to use a client-server model, where the client sends the request to the server, the server processes the images with the desired parameters, and send back the changed files.
